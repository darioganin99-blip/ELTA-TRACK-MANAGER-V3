...
/* ===== V3.3.12 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2='3.3.12';
...
/* ===== V3.3.12 - Version y menu lateral robustos ===== */
(function(){
...
/* ===== V3.3.12 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V3.3.12 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 3.3.12 ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "3.3.12";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V3.3.12 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V3.3.12 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V3.3.12 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2173 = '3.3.12';
...
/* ===== V3.3.12 - Menu base limpio: normalizadores anteriores removidos ===== */
/* ===== V3.3.12 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Librerias externas: PDF y mapa ===== */
(function(){
  const VERSION='3.3.12';
...
/* ===== v3.3.12 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '3.3.12';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 3.3.12';});
})();


/* ===== V3.3.12 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "3.3.12";
...
/* ===== V3.3.12 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "3.3.12";
...
/* ===== V3.3.12 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V3.3.12 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='3.3.12';
...
/* ===== V3.3.12 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='3.3.12';
  ...
  // setInterval(setVersionLabelsV273,1000); // desactivado v3.3.12
})();


/* ===== V3.3.12 - Version lock definitivo ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
  ...
  // setInterval(applyVersionLock, 800); // desactivado v3.3.12
})();


/* ===== V3.3.12 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='3.3.12';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
  ...
  function enhanceDeleteButtons(){ /* v3.3.12 neutralizado: eliminar ya nace en el render */ return; }
...
/* ===== V3.3.12 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V3.3.12 - MENU LATERAL ESTABLE: sin intervalos ni reescrituras repetidas ===== */
(function(){
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.12 - ENTREGAS: ROUTING UNICO SIN REFRESH ===== */
(function(){
  'use strict';
  const VERSION='3.3.12';
  window.ELTA_APP_VERSION=VERSION;
...
/* ===== v3.3.12 - Entregas: abreviatura en origen del render ===== */
...
/* ===== v3.3.12 - CSS final linea desde circulo Entregas ===== */
(function(){
  const CSS = '\n/* ===== v3.3.12 - Entregas: linea vertical nace desde el circulo =====\n   SOLO afecta la vista #entrega. No modifica icono de camion ni otros modulos. */\n\n#entrega .entregaStep.hasDate::before{\n  content:"" !important;\n  position:absolute !important;\n  left:50% !important;\n  top:32px !important;\n  height:33px !important;\n  border-left:2px dotted rgba(226,232,240,.72) !important;\n  transform:translateX(-50%) !important;\n  z-index:2 !important;\n}\n\n#entrega .entregaStep::after{\n  top:65px !important;\n  z-index:4 !important;\n}\n\n#entrega .entregaStep.hasDate[style*="left:0%"]::before{\n  left:6px !important;\n  transform:none !important;\n}\n\n#entrega .entregaStep.hasDate[style*="left:100%"]::before{\n  left:auto !important;\n  right:6px !important;\n  transform:none !important;\n}\n\n#entrega .entregaStep:not(.hasDate)::before{\n  content:none !important;\n  display:none !important;\n}\n';
...
/* ===== v3.3.12 - Entregas: avance por registros + bandera Tierra del Fuego =====
...
/* ===== v3.3.12 - Entregas: timeline por registros reales corregido =====
   Solo afecta la vista Entregas. No modifica diseño ni otros módulos. */
(function(){
  const CSS = `
/* ===== v3.3.12 - Entregas: extremos y registros reales =====
...
`;
  ...
  function attach(){ /* v3.3.12: wrapper v162 desactivado para evitar segundo render de Entregas */ return; }
...
/* ===== v3.3.12 - Entregas: hitos desde Aduanas + camión por último registro ===== */
(function(){
const CSS=`
/* v3.3.12 - Entregas: aduanas y avance real */
...
function attach(){/* v3.3.12: wrapper v163 desactivado para evitar segundo render de Entregas */return}
...
/* ===== v3.3.12 - Entregas: abreviatura visual de hitos =====
...
/* ===== v3.3.12 - Entregas: hitos desde colección aduana por campo destino =====
...
(function(){
  ...
  async function run167(){ /* v3.3.12 desactivado: causaba segundo render heredado de Entregas */ return Promise.resolve(); }
function attach167(){ /* v3.3.12 desactivado */ return; }
document.addEventListener('DOMContentLoaded',()=>{});
...
/* ===== v3.3.12 - Entregas: botón Actualizar refresca timeline =====
...
/* ===== v3.3.12 - Entregas: Actualizar reconstruye la línea como al reingresar =====
   Solo afecta el botón Actualizar de Entregas. No modifica estética ni otros módulos. */
(function(){
...
/* ===== v3.3.12 - Entregas: Actualizar sin parpadeo =====
...
/* ===== v3.3.12 - Entregas: Actualizar in-place sin reconstruir tarjeta =====
   Solo afecta el botón Actualizar de Entregas.
...
/* ===== v3.3.12 - Entregas: Actualizar aislado, sin render viejo =====
   Solo afecta el botón Actualizar de Entregas.
...
/* ===== v3.3.12 - Version final + Entregas boton aislado dominante ===== */
(function(){
  const VERSION_FINAL_173 = '3.3.12';
...
/* ===== v3.3.12 - Reporte PDF: hitos desde colección aduana =====
...
/* ===== v3.3.12 - Forzado final de versión visible y PDF ===== */
(function(){
  const VERSION_FINAL_177 = '3.3.12';
...
/* ===== v3.3.12 - Alertas: sin KM heredado, sin observers =====
   Base v3.3.12. Solo afecta Alertas. No toca Tránsitos, Entregas, PDF ni estética. */
(function(){
  const VERSION_ALERTAS_183='3.3.12';
...
/* ===== v3.3.12 - Alertas: columnas alineadas sin KM =====
   Solo ajusta la tabla de detalle de Alertas. No toca otros modulos. */
(function(){
  const VERSION_ALERTAS_185='3.3.12';
...
/* ===== v3.3.12 - Entregas: evitar flash de hito inicio largo =====
   Solo afecta el texto visual del hito de inicio CLZ/CLC. */
(function(){
  const VERSION_ENTREGA_186='3.3.12';
  function apply186(){
    document.querySelectorAll('#entrega .entregaStep b').forEach(el=>{
...
/* ===== v3.3.12 - Entregas: render único sin postproceso heredado =====
   Solo afecta Entregas. No toca Alertas, Tránsitos, PDF, Firebase ni estética. */
(function(){
  const VERSION_ENTREGA_188='3.3.12';
...
/* ===== v3.3.12 - Entregas: render único, sin wrappers heredados =====
   Solo afecta Entregas. No toca Alertas, Tránsitos, PDF, Firebase ni estética. */
(function(){
  const VERSION_ENTREGA_189='3.3.12';
...
/* ===== v3.3.12 - Entregas: render definitivo unico =====
...
(function(){
  const VERSION_ENTREGAS_190 = '3.3.12';
...
/* ===== v3.3.12 - Entregas: marcar hito final cuando el tránsito está cerrado =====
   Solo afecta la línea de tiempo de Entregas. */
(function(){
  const VERSION_ENTREGA_191='3.3.12';
...
/* ===== v3.3.12 - Entregas: cierre marca último hito =====
   Solo afecta la marcación visual de tarjetas cerradas en Entregas. */
(function(){
  const VERSION_ENTREGA_192='3.3.12';
...
/* ===== v3.3.12 - Entregas: cierre gana contra render heredado tardío =====
   Solo afecta la vista Entregas. Corrección finita, sin observer ni intervalos. */
(function(){
  const VERSION_ENTREGA_193='3.3.12';
...
(function(){
  ...
  async function finalRefresh195(btn){
    ...
    try{
      ...
      /* v3.3.12: renders tardíos heredados desactivados */
    }finally{
      setTimeout(()=>{
        if(b){ b.disabled=false; b.textContent=old || 'Actualizar'; }
        busy195=false;
...
/* ===== v3.3.12 - Entregas: fecha correcta de cierre y última actualización =====
   Solo afecta Entregas. Toma la fecha más nueva de registros del tránsito para cerrado. */
(function(){
  const VERSION_ENTREGA_196='3.3.12';
...
/* ===== v3.3.12 - Forzar version visible ===== */
(function(){
  const V='3.3.12';
...
/* ===== v3.3.12 - Embarques only: sin render heredado =====
...
/* ===== v3.3.12 - Eliminar embarque real + hitos intermedios Entregas =====
   Corrige:
...
/* ===== v3.3.12 - Limpieza definitiva Entregas + Embarques =====
...
/* ===== v3.3.12 - Forzado final de version visible ===== */
(function(){
  const V='3.3.12';
  window.ELTA_APP_VERSION=V;
  window.APP_VERSION_V2=V;
...
/* ===== v3.3.12 - Confirmación eliminar + hitos Entregas por embarque =====
   Ajuste puntual:
...
/* ===== v3.3.12 - Ajustes Embarques + Entregas =====
...
/* ===== v3.3.12 - Proyecto limpio deploy =====
...
/* ===== v3.3.12 - Corrección final línea de tiempo Entregas =====
...
/* ===== v3.3.12 - Bloqueo del último hito Entregas =====
   Mantiene la lógica de v3.3.12, pero evita que un render heredado posterior
...
/* ===== v3.3.12 - Entregas: bloqueo fuerte render heredado ultimo hito + modal rojo ===== */
(function(){
  const V='3.3.12';
  window.ELTA_APP_VERSION=V;
  window.APP_VERSION_V2=V;
...
/* ===== v3.3.12 - Bloqueo del render heredado que escribe INICIO =====
...
/* ===== v3.3.12 - Entregas: render final estable sin refresh heredado =====
...
/* ===== v3.3.12 - Entregas: bloqueo mínimo de INICIO sin tocar carga de datos =====
   Base: v3.3.12 estable. No modifica Firebase, refresh ni render principal.
...
/* ===== v3.3.12 - Entregas: fechas cierre + separación línea punteada =====
   Base v3.3.12. No toca Firebase ni render principal.
...
/* ===== v3.3.12 - Entregas: fechas inicio/cierre desde objetos Firebase + línea corta =====
   Base v3.3.12. No toca la carga de datos. Corrige sólo visualización final. */
(function(){
  const V='3.3.12';
  window.ELTA_APP_VERSION=V;
  window.APP_VERSION_V2=V;
...
/* ===== v3.3.12 - Entregas: fechas inicio/cierre robustas + línea vertical mínima =====
...
/* ===== ELTA v3.3.12 - VERSION Y DOCUMENTACION FINAL LIMPIA ===== */
(function(){
  'use strict';
  const VERSION='3.3.12';
...
/* ===== v3.3.12 - BITACORA OPERATIVA: MODULO UNICO SIN RENDER HEREDADO ===== */
(function(){
  'use strict';
  const VERSION='3.3.12';
  ...
  async function renderSelectedEventMap(ev){
    ...
    L.marker([pos.lat,pos.lng],{icon}).addTo(bitacoraEventMap).bindPopup(`<b>${E(ev?.label||ev?.type||'Evento')}</b><br>${E(ev?.loc||'')}`).openPopup();
  ...
  function buildEvents(t){
    const out=[];if(t){const r=route(t),start=t.start?.time||t.start||t.inicio||t.fechaInicio||t.createdAt;out.push({key:'start',type:'Inicio',label:'Inicio de tránsito',time:start,loc:S(r.origen||t.origen||'-'),source:'APK',user:S(t.user?.name||t.chofer||userForFleet(fleet(t))||'-'),obs:'Inicio del tránsito',raw:t});(t.alerts||[]).forEach((a,i)=>out.push({key:'ta'+i,type:S(a.tipo||a.type||'Alerta'),label:S(a.tipo||a.type||'Alerta'),time:a.time||a.fecha||a.createdAt,loc:S(a.localidad||a.ubicacion||locationOf(t)||'-'),source:S(a.origenRegistro||a.source||'APK'),user:S(a.usuario||a.user||'-'),obs:S(a.observacion||a.descripcion||''),raw:a}));if(!open(t))out.push({key:'end',type:'Fin',label:'Fin de tránsito',time:t.closed?.time||t.closed||t.fechaCierre,loc:S(r.destino||t.destino||'-'),source:'APK',user:S(t.user?.name||'-'),obs:'Cierre del tránsito',raw:t.closed||t});else out.push({key:'pending',type:'Pendiente',label:'Fin de tránsito',time:null,loc:S(r.destino||t.destino||'-'),source:'-',user:'-',obs:'Pendiente',raw:t})}
    state.extra.alertas.forEach((a,i)=>out.push({key:'a'+i,type:S(a.tipo||a.nombre||'Alerta'),label:S(a.tipo||a.nombre||'Alerta'),time:a.fecha||a.time||a.createdAt,loc:S(a.localidad||a.ubicacion||'-'),source:S(a.origenRegistro||'WEB'),user:S(a.usuario||a.creadoPor||'-'),obs:S(a.observacion||a.descripcion||''),raw:a}));
    state.extra.aduana.forEach((a,i)=>out.push({key:'d'+i,type:'Aduana',label:S(a.aduana||a.nombre||'Aduana'),time:a.fecha||a.time||a.createdAt,loc:S(a.localidad||a.aduana||'-'),source:S(a.origenRegistro||'WEB'),user:S(a.usuario||a.creadoPor||'-'),obs:S(a.observacion||''),raw:a}));
    state.extra.checklists.forEach((a,i)=>out.push({key:'c'+i,type:'Checklist',label:S(a.tipo||'Checklist OEA'),time:a.fecha||a.time||a.createdAt,loc:S(a.localidad||a.ubicacion||'-'),source:S(a.origenRegistro||'WEB'),user:S(a.usuario||a.creadoPor||'-'),obs:S(a.observacion||''),raw:a}));
  ...
  function renderData(){const root=byId('bitacoraRoot');if(!root)return;const t=findTransit(state.embarque),e=findShipment(state.embarque),r=route(t);const cliente=S(r.cliente||e?.cliente||t?.cliente||'-'),origen=S(r.origen||e?.origen||t?.origen||'-'),destino=S(r.destino||e?.destino||t?.destino||'-'),fl=fleet(t)||fleet(e)||'-',chofer=S(t?.user?.name||t?.chofer||userForFleet(fl)||'-'),estado=t?(open(t)?'En tránsito':'Finalizado'):'Sin tránsito',start=t?.start?.time||t?.start||t?.inicio||t?.fechaInicio,last=(()=>{try{return typeof lastU==='function'?lastU(t):null}catch(_){return null}})(),events=buildEvents(t);if(!state.eventKey&&events[0])state.eventKey=events[0].key;const selected=events.find(x=>x.key===state.eventKey)||events[0];const count=events.filter(x=>x.type!=='Pendiente').length;root.innerHTML=renderSearch(optionsData())+`<div class="b344Card b344Summary"><div class="b344Info"><small>Embarque</small><b class="green">${E(state.embarque)}</b></div><div class="b344Info"><small>Cliente</small><b>${E(cliente)}</b></div><div class="b344Info"><small>Flota / Chofer</small><b>${E(fl)} / ${E(chofer)}</b></div><div class="b344Info"><small>Origen</small><b>${E(origen)}</b></div><div class="b344Info"><small>Destino</small><b>${E(destino)}</b></div><div class="b344Info"><small>Estado</small><b class="green">${E(estado)}</b></div></div><div class="b344Card b344ProgressNew">${renderRouteTimeline(events,origen,destino,estado)}</div><div class="b344Grid"><div class="b344Card b344Pane"><h3>Línea de tiempo del tránsito</h3>${events.map(ev=>`<div class="b344Event ${ev.key===state.eventKey?'active':''}" onclick="window.selectBitacoraEvent('${E(ev.key)}')"><span class="date">${E(fmt(ev.time))}</span><span class="ico">${eventIcon(ev.type)}</span><span><b>${E(ev.label)}</b><small>${E(ev.loc)}</small></span><em>${E(ev.source)}</em></div>`).join('')||'<div class="b344Empty">Sin eventos registrados.</div>'}</div><div class="b344Card b344Pane"><h3>Detalle del evento seleccionado</h3>${selected?`<div class="b344Detail"><div class="b344Box"><small>Tipo</small><b>${E(selected.type)}</b></div><div class="b344Box"><small>Fecha / Hora</small><b>${E(fmt(selected.time))}</b></div><div class="b344Box"><small>Usuario</small><b>${E(selected.user)}</b></div><div class="b344Box"><small>Origen registro</small><b>${E(selected.source)}</b></div><div class="b344Box"><small>Ubicación</small><b>${E(selected.loc)}</b></div></div><div class="b344Obs">${E(selected.obs||'Sin observaciones.')}</div><div class="b344EventMapWrap"><div class="b344EventMapTitle"><span>Mapa del evento</span><span>${E(selected.loc||'')}</span></div><div id="b344EventMap" class="b344EventMap"></div><div id="b344MapStatus" class="b344MapStatus">Cargando ubicación...</div></div>`:'<div class="b344Empty">Seleccione un evento.</div>'}</div><div class="b344Card b344Pane"><h3>Estado actual del tránsito</h3><div class="b344Side"><small>Último GPS</small><b>${E(last?fmt(last.time||last.fecha||last.createdAt):'-')}</b><div>${E(locationOf(t)||'-')}</div></div><div class="b344Side"><small>Próximo hito</small><b>${E(destino)}</b></div><div class="b344Side"><small>Resumen</small><b>${count} eventos</b><div>Estado: ${E(estado)}</div></div></div></div><div class="b344Card b344Actions"><button class="green">Iniciar tránsito</button><button class="blue">Nueva aduana</button><button class="yellow">Nueva alerta</button><button>Checklist OEA</button><button>Documento</button><button>Generar PDF</button><button class="red">Cerrar tránsito</button></div>`;bindFilters();setTimeout(()=>renderSelectedEventMap(selected),0)}
