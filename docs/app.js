...
/* ===== V3.1.4 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2='3.1.4';
...
/* ===== V3.1.4 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "3.1.4";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V3.1.4 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V3.1.4 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V3.1.4 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2173 = '3.1.4';
...
/* ===== v3.1.4 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '3.1.4';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 3.1.4';});
})();
...
/* ===== V3.1.4 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "3.1.4";
...
/* ===== V3.1.4 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "3.1.4";
...
/* ===== V3.1.4 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='3.1.4';
...
/* ===== V3.1.4 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='3.1.4';
  ...
  // setInterval(setVersionLabelsV273,1000); // desactivado v3.1.4
})();
...
(function(){
  ...
  // setInterval(applyVersionLock, 800); // desactivado v3.1.4
})();
...
(function(){
  ...
  function enhanceDeleteButtons(){ /* v3.1.4 neutralizado: eliminar ya nace en el render */ return; }
...
/* ===== V3.1.4 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== v3.1.4 - Entregas: abreviatura en origen del render ===== */
...
/* ===== v3.1.4 - CSS final linea desde circulo Entregas ===== */
(function(){
  const CSS = '\n/* ===== v3.1.4 - Entregas: linea vertical nace desde el circulo =====\n   SOLO afecta la vista #entrega. No modifica icono de camion ni otros modulos. */\n\n#entrega .entregaStep.hasDate::before{\n  content:"" !important;\n  position:absolute !important;\n  left:50% !important;\n  top:32px !important;\n  height:33px !important;\n  border-left:2px dotted rgba(226,232,240,.72) !important;\n  transform:translateX(-50%) !important;\n  z-index:2 !important;\n}\n\n#entrega .entregaStep::after{\n  top:65px !important;\n  z-index:4 !important;\n}\n\n#entrega .entregaStep.hasDate[style*="left:0%"]::before{\n  left:6px !important;\n  transform:none !important;\n}\n\n#entrega .entregaStep.hasDate[style*="left:100%"]::before{\n  left:auto !important;\n  right:6px !important;\n  transform:none !important;\n}\n\n#entrega .entregaStep:not(.hasDate)::before{\n  content:none !important;\n  display:none !important;\n}\n';
...
/* ===== v3.1.4 - Entregas: avance por registros + bandera Tierra del Fuego =====
...
/* ===== v3.1.4 - Entregas: timeline por registros reales corregido =====
   Solo afecta la vista Entregas. No modifica diseño ni otros módulos. */
(function(){
  const CSS = `
/* ===== v3.1.4 - Entregas: extremos y registros reales =====
...
`;
  ...
  function attach(){ /* v3.1.4: wrapper v162 desactivado para evitar segundo render de Entregas */ return; }
...
/* ===== v3.1.4 - Entregas: hitos desde Aduanas + camión por último registro ===== */
(function(){
const CSS=`
/* v3.1.4 - Entregas: aduanas y avance real */
...
function attach(){/* v3.1.4: wrapper v163 desactivado para evitar segundo render de Entregas */return}
...
/* ===== v3.1.4 - Entregas: abreviatura visual de hitos =====
...
/* ===== v3.1.4 - Entregas: hitos desde colección aduana por campo destino =====
...
(function(){
  ...
  async function run167(){ /* v3.1.4 desactivado: causaba segundo render heredado de Entregas */ return Promise.resolve(); }
function attach167(){ /* v3.1.4 desactivado */ return; }
document.addEventListener('DOMContentLoaded',()=>{});
...
/* ===== v3.1.4 - Entregas: botón Actualizar refresca timeline =====
...
/* ===== v3.1.4 - Entregas: Actualizar reconstruye la línea como al reingresar =====
   Solo afecta el botón Actualizar de Entregas. No modifica estética ni otros módulos. */
(function(){
...
/* ===== v3.1.4 - Entregas: Actualizar sin parpadeo =====
...
/* ===== v3.1.4 - Entregas: Actualizar in-place sin reconstruir tarjeta =====
   Solo afecta el botón Actualizar de Entregas.
...
/* ===== v3.1.4 - Entregas: Actualizar aislado, sin render viejo =====
   Solo afecta el botón Actualizar de Entregas.
...
/* ===== v3.1.4 - Version final + Entregas boton aislado dominante ===== */
(function(){
  const VERSION_FINAL_173 = '3.1.4';
...
/* ===== v3.1.4 - Reporte PDF: hitos desde colección aduana =====
...
/* ===== v3.1.4 - Forzado final de versión visible y PDF ===== */
(function(){
  const VERSION_FINAL_177 = '3.1.4';
...
/* ===== v3.1.4 - Alertas: sin KM heredado, sin observers =====
   Base v3.1.4. Solo afecta Alertas. No toca Tránsitos, Entregas, PDF ni estética. */
(function(){
  const VERSION_ALERTAS_183='3.1.4';
...
/* ===== v3.1.4 - Alertas: columnas alineadas sin KM =====
   Solo ajusta la tabla de detalle de Alertas. No toca otros modulos. */
(function(){
  const VERSION_ALERTAS_185='3.1.4';
...
/* ===== v3.1.4 - Entregas: evitar flash de hito inicio largo =====
   Solo afecta el texto visual del hito de inicio CLZ/CLC. */
(function(){
  const VERSION_ENTREGA_186='3.1.4';
  function apply186(){
    document.querySelectorAll('#entrega .entregaStep b').forEach(el=>{
...
/* ===== v3.1.4 - Entregas: render único sin postproceso heredado =====
   Solo afecta Entregas. No toca Alertas, Tránsitos, PDF, Firebase ni estética. */
(function(){
  const VERSION_ENTREGA_188='3.1.4';
...
/* ===== v3.1.4 - Entregas: render único, sin wrappers heredados =====
   Solo afecta Entregas. No toca Alertas, Tránsitos, PDF, Firebase ni estética. */
(function(){
  const VERSION_ENTREGA_189='3.1.4';
...
/* ===== v3.1.4 - Entregas: render definitivo unico =====
...
(function(){
  const VERSION_ENTREGAS_190 = '3.1.4';
...
/* ===== v3.1.4 - Entregas: marcar hito final cuando el tránsito está cerrado =====
   Solo afecta la línea de tiempo de Entregas. */
(function(){
  const VERSION_ENTREGA_191='3.1.4';
...
/* ===== v3.1.4 - Entregas: cierre marca último hito =====
   Solo afecta la marcación visual de tarjetas cerradas en Entregas. */
(function(){
  const VERSION_ENTREGA_192='3.1.4';
...
/* ===== v3.1.4 - Entregas: cierre gana contra render heredado tardío =====
   Solo afecta la vista Entregas. Corrección finita, sin observer ni intervalos. */
(function(){
  const VERSION_ENTREGA_193='3.1.4';
...
(function(){
  ...
  async function finalRefresh195(btn){
    ...
    try{
      ...
      /* v3.1.4: renders tardíos heredados desactivados */
    }finally{
      setTimeout(()=>{
        if(b){ b.disabled=false; b.textContent=old || 'Actualizar'; }
        busy195=false;
...
/* ===== v3.1.4 - Entregas: fecha correcta de cierre y última actualización =====
   Solo afecta Entregas. Toma la fecha más nueva de registros del tránsito para cerrado. */
(function(){
  const VERSION_ENTREGA_196='3.1.4';
...
/* ===== v3.1.4 - Embarques only: sin render heredado =====
...
/* ===== v3.1.4 - Eliminar embarque real + hitos intermedios Entregas =====
   Corrige:
...
/* ===== v3.1.4 - Limpieza definitiva Entregas + Embarques =====
...
/* ===== v3.1.4 - Forzado final de version visible ===== */
(function(){
  const V='3.1.4';
  window.ELTA_APP_VERSION=V;
  window.APP_VERSION_V2=V;
...
/* ===== v3.1.4 - Confirmación eliminar + hitos Entregas por embarque =====
   Ajuste puntual:
...
/* ===== v3.1.4 - Ajustes Embarques + Entregas =====
...
/* ===== v3.1.4 - Corrección final línea de tiempo Entregas =====
...
/* ===== v3.1.4 - Bloqueo del último hito Entregas =====
   Mantiene la lógica de v3.1.4, pero evita que un render heredado posterior
...
/* ===== v3.1.4 - Entregas: bloqueo fuerte render heredado ultimo hito + modal rojo ===== */
(function(){
  const V='3.1.4';
  window.ELTA_APP_VERSION=V;
  window.APP_VERSION_V2=V;
...
/* ===== v3.1.4 - Bloqueo del render heredado que escribe INICIO =====
...
/* ===== v3.1.4 - Entregas: render final estable sin refresh heredado =====
...
/* ===== v3.1.4 - Entregas: bloqueo mínimo de INICIO sin tocar carga de datos =====
   Base: v3.1.4 estable. No modifica Firebase, refresh ni render principal.
...
/* ===== v3.1.4 - Entregas: fechas cierre + separación línea punteada =====
   Base v3.1.4. No toca Firebase ni render principal.
...
/* ===== v3.1.4 - Entregas: fechas inicio/cierre desde objetos Firebase + línea corta =====
   Base v3.1.4. No toca la carga de datos. Corrige sólo visualización final. */
(function(){
  const V='3.1.4';
  window.ELTA_APP_VERSION=V;
  window.APP_VERSION_V2=V;
...
/* ===== v3.1.4 - Entregas: fechas inicio/cierre robustas + línea vertical mínima =====
...
/* ===== v3.1.7 - Bitácora Operativa Sprint 2: datos reales solo lectura =====
...
/* ===== v3.1.7 - Bitácora Operativa Sprint 2 UX compacta =====
