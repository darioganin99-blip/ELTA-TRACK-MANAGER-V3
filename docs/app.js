...
/* ===== V3.3.20 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2='3.3.20';
...
/* ===== V3.3.20 - Version y menu lateral robustos ===== */
(function(){
...
/* ===== V3.3.20 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V3.3.20 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 3.3.20 ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "3.3.20";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V3.3.20 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V3.3.20 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V3.3.20 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2173 = '3.3.20';
...
/* ===== V3.3.20 - Menu base limpio: normalizadores anteriores removidos ===== */
/* ===== V3.3.20 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Librerias externas: PDF y mapa ===== */
(function(){
  const VERSION='3.3.20';
...
/* ===== v3.3.20 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '3.3.20';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 3.3.20';});
})();


/* ===== V3.3.20 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "3.3.20";
...
/* ===== V3.3.20 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "3.3.20";
...
/* ===== V3.3.20 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V3.3.20 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='3.3.20';
...
/* ===== V3.3.20 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='3.3.20';
  ...
  // setInterval(setVersionLabelsV273,1000); // desactivado v3.3.20
})();


/* ===== V3.3.20 - Version lock definitivo ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
  ...
  // setInterval(applyVersionLock, 800); // desactivado v3.3.20
})();


/* ===== V3.3.20 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='3.3.20';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
  ...
  function enhanceDeleteButtons(){ /* v3.3.20 neutralizado: eliminar ya nace en el render */ return; }
...
/* ===== V3.3.20 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V3.3.20 - MENU LATERAL ESTABLE: sin intervalos ni reescrituras repetidas ===== */
(function(){
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.20 - ENTREGAS: ROUTING UNICO SIN REFRESH ===== */
(function(){
  'use strict';
  const VERSION='3.3.20';
  window.ELTA_APP_VERSION=VERSION;
...
/* ===== v3.3.20 - Entregas: abreviatura en origen del render ===== */
...
/* ===== v3.3.20 - CSS final linea desde circulo Entregas ===== */
(function(){
  const CSS = '\n/* ===== v3.3.20 - Entregas: linea vertical nace desde el circulo =====\n   SOLO afecta la vista #entrega. No modifica icono de camion ni otros modulos. */\n\n#entrega .entregaStep.hasDate::before{\n  content:"" !important;\n  position:absolute !important;\n  left:50% !important;\n  top:32px !important;\n  height:33px !important;\n  border-left:2px dotted rgba(226,232,240,.72) !important;\n  transform:translateX(-50%) !important;\n  z-index:2 !important;\n}\n\n#entrega .entregaStep::after{\n  top:65px !important;\n  z-index:4 !important;\n}\n\n#entrega .entregaStep.hasDate[style*="left:0%"]::before{\n  left:6px !important;\n  transform:none !important;\n}\n\n#entrega .entregaStep.hasDate[style*="left:100%"]::before{\n  left:auto !important;\n  right:6px !important;\n  transform:none !important;\n}\n\n#entrega .entregaStep:not(.hasDate)::before{\n  content:none !important;\n  display:none !important;\n}\n';
...
/* ===== v3.3.20 - Entregas: avance por registros + bandera Tierra del Fuego =====
...
/* ===== v3.3.20 - Entregas: timeline por registros reales corregido =====
   Solo afecta la vista Entregas. No modifica diseño ni otros módulos. */
(function(){
  const CSS = `
/* ===== v3.3.20 - Entregas: extremos y registros reales =====
...
`;
  ...
  function attach(){ /* v3.3.20: wrapper v162 desactivado para evitar segundo render de Entregas */ return; }
...
/* ===== v3.3.20 - Entregas: hitos desde Aduanas + camión por último registro ===== */
(function(){
const CSS=`
/* v3.3.20 - Entregas: aduanas y avance real */
...
function attach(){/* v3.3.20: wrapper v163 desactivado para evitar segundo render de Entregas */return}
...
/* ===== v3.3.20 - Entregas: abreviatura visual de hitos =====
...
/* ===== v3.3.20 - Entregas: hitos desde colección aduana por campo destino =====
...
(function(){
  ...
  async function run167(){ /* v3.3.20 desactivado: causaba segundo render heredado de Entregas */ return Promise.resolve(); }
function attach167(){ /* v3.3.20 desactivado */ return; }
document.addEventListener('DOMContentLoaded',()=>{});
...
/* ===== v3.3.20 - Entregas: botón Actualizar refresca timeline =====
...
/* ===== v3.3.20 - Entregas: Actualizar reconstruye la línea como al reingresar =====
   Solo afecta el botón Actualizar de Entregas. No modifica estética ni otros módulos. */
(function(){
...
/* ===== v3.3.20 - Entregas: Actualizar sin parpadeo =====
...
/* ===== v3.3.20 - Entregas: Actualizar in-place sin reconstruir tarjeta =====
   Solo afecta el botón Actualizar de Entregas.
...
/* ===== v3.3.20 - Entregas: Actualizar aislado, sin render viejo =====
   Solo afecta el botón Actualizar de Entregas.
...
/* ===== v3.3.20 - Version final + Entregas boton aislado dominante ===== */
(function(){
  const VERSION_FINAL_173 = '3.3.20';
...
/* ===== v3.3.20 - Reporte PDF: hitos desde colección aduana =====
...
/* ===== v3.3.20 - Forzado final de versión visible y PDF ===== */
(function(){
  const VERSION_FINAL_177 = '3.3.20';
...
/* ===== v3.3.20 - Alertas: sin KM heredado, sin observers =====
   Base v3.3.20. Solo afecta Alertas. No toca Tránsitos, Entregas, PDF ni estética. */
(function(){
  const VERSION_ALERTAS_183='3.3.20';
...
/* ===== v3.3.20 - Alertas: columnas alineadas sin KM =====
   Solo ajusta la tabla de detalle de Alertas. No toca otros modulos. */
(function(){
  const VERSION_ALERTAS_185='3.3.20';
...
/* ===== v3.3.20 - Entregas: evitar flash de hito inicio largo =====
   Solo afecta el texto visual del hito de inicio CLZ/CLC. */
(function(){
  const VERSION_ENTREGA_186='3.3.20';
  function apply186(){
    document.querySelectorAll('#entrega .entregaStep b').forEach(el=>{
...
/* ===== v3.3.20 - Entregas: render único sin postproceso heredado =====
   Solo afecta Entregas. No toca Alertas, Tránsitos, PDF, Firebase ni estética. */
(function(){
  const VERSION_ENTREGA_188='3.3.20';
...
/* ===== v3.3.20 - Entregas: render único, sin wrappers heredados =====
   Solo afecta Entregas. No toca Alertas, Tránsitos, PDF, Firebase ni estética. */
(function(){
  const VERSION_ENTREGA_189='3.3.20';
...
/* ===== v3.3.20 - Entregas: render definitivo unico =====
...
(function(){
  const VERSION_ENTREGAS_190 = '3.3.20';
...
/* ===== v3.3.20 - Entregas: marcar hito final cuando el tránsito está cerrado =====
   Solo afecta la línea de tiempo de Entregas. */
(function(){
  const VERSION_ENTREGA_191='3.3.20';
...
/* ===== v3.3.20 - Entregas: cierre marca último hito =====
   Solo afecta la marcación visual de tarjetas cerradas en Entregas. */
(function(){
  const VERSION_ENTREGA_192='3.3.20';
...
/* ===== v3.3.20 - Entregas: cierre gana contra render heredado tardío =====
   Solo afecta la vista Entregas. Corrección finita, sin observer ni intervalos. */
(function(){
  const VERSION_ENTREGA_193='3.3.20';
...
(function(){
  ...
  async function finalRefresh195(btn){
    ...
    try{
      ...
      /* v3.3.20: renders tardíos heredados desactivados */
    }finally{
      setTimeout(()=>{
        if(b){ b.disabled=false; b.textContent=old || 'Actualizar'; }
        busy195=false;
...
/* ===== v3.3.20 - Entregas: fecha correcta de cierre y última actualización =====
   Solo afecta Entregas. Toma la fecha más nueva de registros del tránsito para cerrado. */
(function(){
  const VERSION_ENTREGA_196='3.3.20';
...
/* ===== v3.3.20 - Forzar version visible ===== */
(function(){
  const V='3.3.20';
...
/* ===== v3.3.20 - Embarques only: sin render heredado =====
...
/* ===== v3.3.20 - Eliminar embarque real + hitos intermedios Entregas =====
   Corrige:
...
/* ===== v3.3.20 - Limpieza definitiva Entregas + Embarques =====
...
/* ===== v3.3.20 - Forzado final de version visible ===== */
(function(){
  const V='3.3.20';
  window.ELTA_APP_VERSION=V;
  window.APP_VERSION_V2=V;
...
/* ===== v3.3.20 - Confirmación eliminar + hitos Entregas por embarque =====
   Ajuste puntual:
...
/* ===== v3.3.20 - Ajustes Embarques + Entregas =====
...
/* ===== v3.3.20 - Proyecto limpio deploy =====
...
/* ===== v3.3.20 - Corrección final línea de tiempo Entregas =====
...
/* ===== v3.3.20 - Bloqueo del último hito Entregas =====
   Mantiene la lógica de v3.3.20, pero evita que un render heredado posterior
...
/* ===== v3.3.20 - Entregas: bloqueo fuerte render heredado ultimo hito + modal rojo ===== */
(function(){
  const V='3.3.20';
  window.ELTA_APP_VERSION=V;
  window.APP_VERSION_V2=V;
...
/* ===== v3.3.20 - Bloqueo del render heredado que escribe INICIO =====
...
/* ===== v3.3.20 - Entregas: render final estable sin refresh heredado =====
...
/* ===== v3.3.20 - Entregas: bloqueo mínimo de INICIO sin tocar carga de datos =====
   Base: v3.3.20 estable. No modifica Firebase, refresh ni render principal.
...
/* ===== v3.3.20 - Entregas: fechas cierre + separación línea punteada =====
   Base v3.3.20. No toca Firebase ni render principal.
...
/* ===== v3.3.20 - Entregas: fechas inicio/cierre desde objetos Firebase + línea corta =====
   Base v3.3.20. No toca la carga de datos. Corrige sólo visualización final. */
(function(){
  const V='3.3.20';
  window.ELTA_APP_VERSION=V;
  window.APP_VERSION_V2=V;
...
/* ===== v3.3.20 - Entregas: fechas inicio/cierre robustas + línea vertical mínima =====
...
/* ===== ELTA v3.3.20 - VERSION Y DOCUMENTACION FINAL LIMPIA ===== */
(function(){
  'use strict';
  const VERSION='3.3.20';
...
/* ===== v3.3.20 - BITACORA OPERATIVA: MODULO UNICO SIN RENDER HEREDADO ===== */
(function(){
  'use strict';
  const VERSION='3.3.20';
...
/* ===== ELTA v3.3.20 - PANEL OPERATIVO INICIAR TRANSITO ===== */
(function(){
  'use strict';
  const VERSION='3.3.20';
  const $=id=>document.getElementById(id);
  ...
  function injectCss(){if($('st320Css'))return;const st=document.createElement('style');st.id='st320Css';st.textContent=`.st320Overlay{position:fixed;inset:0;z-index:999999;background:rgba(2,10,18,.68);display:flex;justify-content:flex-end;backdrop-filter:blur(2px)}.st320Panel{width:min(720px,48vw);height:100vh;background:#f8fafc;color:#0f172a;box-shadow:-16px 0 40px rgba(0,0,0,.38);display:flex;flex-direction:column;animation:st320In .22s ease-out}@keyframes st320In{from{transform:translateX(100%)}to{transform:none}}.st320Head{padding:20px 24px;border-bottom:1px solid #d7dee8;display:flex;justify-content:space-between;align-items:flex-start}.st320Head h2{margin:0;font-size:24px}.st320Head h2 span{color:#2d9e3f}.st320Head p{margin:4px 0 0;color:#475569}.st320Head button{border:0;background:transparent;font-size:32px;line-height:1;cursor:pointer}.st320Body{padding:16px 22px 22px;overflow:auto;flex:1}.st320Step{padding:0 0 15px;margin-bottom:15px;border-bottom:1px solid #d8e0e8}.st320Step h3{font-size:15px;margin:0 0 12px}.st320Step h3 i{display:inline-grid;place-items:center;width:24px;height:24px;border-radius:50%;background:#2d9e3f;color:#fff;font-style:normal;margin-right:7px}.st320Inline,.st320FleetRow{display:grid;grid-template-columns:1fr 150px;gap:10px;align-items:end}.st320Step label span{display:block;font-size:12px;font-weight:800;margin-bottom:6px}.st320Step input,.st320Step select{width:100%;height:42px;border:1px solid #cbd5e1;border-radius:8px;padding:0 12px;background:#fff;color:#0f172a;font-weight:700}.st320Step button,.st320Foot button{height:42px;border-radius:8px;border:1px solid #b8c3d1;background:#fff;font-weight:900;cursor:pointer}.st320Step .primary,.st320Foot .primary{background:#2d9e3f;color:#fff;border-color:#2d9e3f}.st320Result{margin-top:10px;border-radius:9px;padding:12px;border:1px solid #d9e1ea}.st320Result.ok{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;background:#e9f7e9;border-color:#b7dfba}.st320Result.ok p{grid-column:1/-1;margin:2px 0 0}.st320Result small,.st320Data small{display:block;color:#64748b;font-size:10px;text-transform:uppercase;font-weight:900}.st320Result b,.st320Data b{display:block;margin-top:3px}.st320Result.error,.st320FleetState.error{background:#fff0f0;border-color:#f3b3b3;color:#991b1b}.muted{color:#64748b;background:#f1f5f9}.st320FleetState{min-height:42px;border:1px solid #d9e1ea;border-radius:8px;padding:7px 10px;font-weight:800}.st320FleetState.ok{background:#e9f7e9;color:#166534;border-color:#b7dfba}.st320FleetState small{font-weight:600}.st320Data{display:grid;grid-template-columns:repeat(3,1fr);border:1px solid #d9e1ea;border-radius:9px;overflow:hidden}.st320Data>div{padding:10px;border-right:1px solid #d9e1ea;border-bottom:1px solid #d9e1ea;min-height:62px}.st320Location{display:grid;grid-template-columns:230px 1fr;gap:12px}.st320Radios label{display:block;margin:0 0 12px;font-weight:700}.st320Radios input{width:auto;height:auto;margin-right:7px}.st320Map{height:210px;border:1px solid #cbd5e1;border-radius:9px;background:#e2e8f0;overflow:hidden;display:grid;place-items:center}.st320Coords{margin-top:8px;padding:8px 10px;border-radius:7px;background:#e9f7e9;color:#166534;font-weight:800;font-size:12px}.st320Status{min-height:22px;padding:7px 10px;border-radius:7px;font-weight:800;font-size:12px}.st320Status.error{background:#fee2e2;color:#991b1b}.st320Status.ok{background:#dcfce7;color:#166534}.st320Status.info{background:#e0f2fe;color:#075985}.st320Foot{padding:14px 22px;border-top:1px solid #d7dee8;display:grid;grid-template-columns:1fr 1.25fr;gap:12px}.st320Foot button:disabled{opacity:.55;cursor:not-allowed}@media(max-width:1000px){.st320Panel{width:92vw}.st320Result.ok,.st320Data{grid-template-columns:1fr 1fr}.st320Location{grid-template-columns:1fr}}`;document.head.appendChild(st)}
