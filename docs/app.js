...
/* ===== V3.3.9 - Nombre oficial del sistema ===== */
(function(){
  const APP_VERSION_V2='3.3.9';
...
/* ===== V3.3.9 - Version y menu lateral robustos ===== */
(function(){
  const VERSION='3.3.9';
...
/* ===== V3.3.9 - Anti-cache y normalizacion final menu/version ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION = VERSION;
...
/* ===== V3.3.9 - Correcciones GPS, clima, alertas y seguimiento ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Ajustes finales clima, KM y alertas ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Ajuste final: menu, clima compacto, KM y alertas alineadas ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Correccion funcional final: menu, clima, KM y alertas compactas ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Vista Alertas compacta: boton Verificar visible ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Torre de Control: Últimas alertas formato linea unica ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Tránsitos: alertas a la derecha y todas las alertas / Seguimiento vuelve a base 3.3.9 ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Iconos por tipo de alerta en Tránsitos y Seguimiento ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - SOLO vista Clima: diseño aprobado Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - SOLO vista Clima: formato operativo compacto Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - SOLO vista Clima: filtro por embarque y orden Flotas -> Pasos -> Destinos ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - SOLO vista Clima: filtro embarques activos + layout compacto corregido ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - SOLO vista Clima: tarjetas compactas + datos operativos + paso real oficial ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - SOLO vista Clima: actualizar funcional, tarjetas compactas y Paso oficial ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - SOLO vista Clima: columnas Flotas | Paso+Destinos, tarjetas compactas ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - SOLO vista Clima: reorganizacion final compacta + paso oficial bajo demanda ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Clima: layout compacto definitivo y Paso con consulta online ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Vista Alertas: resumen con graficos + tabla compacta funcional ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Alertas: graficos en una linea, campana completa, contador funcional ===== */
(function(){
  const VERSION_ALERTS_2035 = "3.3.9";
  const $ = (id)=>document.getElementById(id);
...
/* ===== V3.3.9 - Menu lateral: badge y efecto de campana segun pendientes ===== */
(function(){
...
/* ===== V3.3.9 - Normalizacion final del menu lateral ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Refuerzo campana menu lateral ===== */
(function(){
...
/* ===== V3.3.9 - contador real y badge compacto de menu ===== */
(function(){
  const APP_VERSION_MENU_2173 = '3.3.9';
...
/* ===== V3.3.9 - Menu base limpio: normalizadores anteriores removidos ===== */
/* ===== V3.3.9 - Nuevo modulo Embarques ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Embarques: combos desde colecciones Firestore y estructura real ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Librerias externas: PDF y mapa ===== */
(function(){
  const VERSION='3.3.9';
...
/* ===== v3.3.9 - PDF profesional con logo original ELTA para Vista Tránsitos ===== */
(function(){
  const APP_VERSION_PDF = '3.3.9';
  ...
  document.querySelectorAll('.loginFooter span, .headerTitle span').forEach(el=>{if(/Versi[oó]n/i.test(el.textContent||''))el.textContent='Versión 3.3.9';});
})();


/* ===== V3.3.9 - Fix botones Actualizar global + version unificada ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Configuracion redisenada sin JSON y sin pestana Embarques ===== */
(function(){
  const APP_VERSION_CFG = "3.3.9";
...
/* ===== V3.3.9 - SOLO vista Clima: filtro embarque corrige destino exacto del embarque ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - FIX DEFINITIVO SOLO CLIMA: filtro por embarque trae destino/paso aunque no haya flota ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Datos reales del usuario logueado en sidebar ===== */
(function(){
  const APP_VERSION_LOGGED_USER_FIX = "3.3.9";
...
/* ===== V3.3.9 - Clima compacto + PDF OEA + correcciones puntuales ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  function $id(id){return document.getElementById(id);}
...
/* ===== V3.3.9 - Version + flotas del combo desde usuarios role=flota ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - FIX DEFINITIVO: version, clima compacto y combo flotas desde Firebase ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Embarques: boton Ver cargas en Agregar carga ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - Recuperar password, ajustes Configuracion, Embarques y KM Alertas ===== */
(function(){
  const APP_VERSION_FIX='3.3.9';
...
/* ===== V3.3.9 - Password visible en Configuracion y version unificada ===== */
(function(){
  const APP_VERSION_273='3.3.9';
  ...
  // setInterval(setVersionLabelsV273,1000); // desactivado v3.3.9
})();


/* ===== V3.3.9 - Version lock definitivo ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION = VERSION;
  window.APP_VERSION_V2 = VERSION;
  ...
  // setInterval(applyVersionLock, 800); // desactivado v3.3.9
})();


/* ===== V3.3.9 - Embarques: eliminar registro con confirmacion ===== */
(function(){
  const VERSION='3.3.9';
  const S=v=>String(v==null?'':v).trim();
  const E=v=>S(v).replace(/[&<>"']/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[m]));
  ...
  function enhanceDeleteButtons(){ /* v3.3.9 neutralizado: eliminar ya nace en el render */ return; }
...
/* ===== V3.3.9 - Embarques: papelera sin fondo ===== */
(function(){
  const css=document.createElement('style');
...
/* ===== V3.3.9 - MENU LATERAL ESTABLE: sin intervalos ni reescrituras repetidas ===== */
(function(){
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
  window.APP_VERSION_V2=VERSION;
...
/* ===== V3.3.9 - ENTREGAS: ROUTING UNICO SIN REFRESH ===== */
(function(){
  'use strict';
  const VERSION='3.3.9';
  window.ELTA_APP_VERSION=VERSION;
...
/* ===== v3.3.9 - Entregas: abreviatura en origen del render ===== */
...
/* ===== v3.3.9 - CSS final linea desde circulo Entregas ===== */
(function(){
  const CSS = '\n/* ===== v3.3.9 - Entregas: linea vertical nace desde el circulo =====\n   SOLO afecta la vista #entrega. No modifica icono de camion ni otros modulos. */\n\n#entrega .entregaStep.hasDate::before{\n  content:"" !important;\n  position:absolute !important;\n  left:50% !important;\n  top:32px !important;\n  height:33px !important;\n  border-left:2px dotted rgba(226,232,240,.72) !important;\n  transform:translateX(-50%) !important;\n  z-index:2 !important;\n}\n\n#entrega .entregaStep::after{\n  top:65px !important;\n  z-index:4 !important;\n}\n\n#entrega .entregaStep.hasDate[style*="left:0%"]::before{\n  left:6px !important;\n  transform:none !important;\n}\n\n#entrega .entregaStep.hasDate[style*="left:100%"]::before{\n  left:auto !important;\n  right:6px !important;\n  transform:none !important;\n}\n\n#entrega .entregaStep:not(.hasDate)::before{\n  content:none !important;\n  display:none !important;\n}\n';
...
/* ===== v3.3.9 - Entregas: avance por registros + bandera Tierra del Fuego =====
...
/* ===== v3.3.9 - Entregas: timeline por registros reales corregido =====
   Solo afecta la vista Entregas. No modifica diseño ni otros módulos. */
(function(){
  const CSS = `
/* ===== v3.3.9 - Entregas: extremos y registros reales =====
...
`;
  ...
  function attach(){ /* v3.3.9: wrapper v162 desactivado para evitar segundo render de Entregas */ return; }
...
/* ===== v3.3.9 - Entregas: hitos desde Aduanas + camión por último registro ===== */
(function(){
const CSS=`
/* v3.3.9 - Entregas: aduanas y avance real */
...
function attach(){/* v3.3.9: wrapper v163 desactivado para evitar segundo render de Entregas */return}
...
/* ===== v3.3.9 - Entregas: abreviatura visual de hitos =====
...
/* ===== v3.3.9 - Entregas: hitos desde colección aduana por campo destino =====
...
(function(){
  ...
  async function run167(){ /* v3.3.9 desactivado: causaba segundo render heredado de Entregas */ return Promise.resolve(); }
function attach167(){ /* v3.3.9 desactivado */ return; }
document.addEventListener('DOMContentLoaded',()=>{});
...
/* ===== v3.3.9 - Entregas: botón Actualizar refresca timeline =====
...
/* ===== v3.3.9 - Entregas: Actualizar reconstruye la línea como al reingresar =====
   Solo afecta el botón Actualizar de Entregas. No modifica estética ni otros módulos. */
(function(){
...
/* ===== v3.3.9 - Entregas: Actualizar sin parpadeo =====
...
/* ===== v3.3.9 - Entregas: Actualizar in-place sin reconstruir tarjeta =====
   Solo afecta el botón Actualizar de Entregas.
...
/* ===== v3.3.9 - Entregas: Actualizar aislado, sin render viejo =====
   Solo afecta el botón Actualizar de Entregas.
...
/* ===== v3.3.9 - Version final + Entregas boton aislado dominante ===== */
(function(){
  const VERSION_FINAL_173 = '3.3.9';
...
/* ===== v3.3.9 - Reporte PDF: hitos desde colección aduana =====
...
/* ===== v3.3.9 - Forzado final de versión visible y PDF ===== */
(function(){
  const VERSION_FINAL_177 = '3.3.9';
...
/* ===== v3.3.9 - Alertas: sin KM heredado, sin observers =====
   Base v3.3.9. Solo afecta Alertas. No toca Tránsitos, Entregas, PDF ni estética. */
(function(){
  const VERSION_ALERTAS_183='3.3.9';
...
/* ===== v3.3.9 - Alertas: columnas alineadas sin KM =====
   Solo ajusta la tabla de detalle de Alertas. No toca otros modulos. */
(function(){
  const VERSION_ALERTAS_185='3.3.9';
...
/* ===== v3.3.9 - Entregas: evitar flash de hito inicio largo =====
   Solo afecta el texto visual del hito de inicio CLZ/CLC. */
(function(){
  const VERSION_ENTREGA_186='3.3.9';
  function apply186(){
    document.querySelectorAll('#entrega .entregaStep b').forEach(el=>{
...
/* ===== v3.3.9 - Entregas: render único sin postproceso heredado =====
   Solo afecta Entregas. No toca Alertas, Tránsitos, PDF, Firebase ni estética. */
(function(){
  const VERSION_ENTREGA_188='3.3.9';
...
/* ===== v3.3.9 - Entregas: render único, sin wrappers heredados =====
   Solo afecta Entregas. No toca Alertas, Tránsitos, PDF, Firebase ni estética. */
(function(){
  const VERSION_ENTREGA_189='3.3.9';
...
/* ===== v3.3.9 - Entregas: render definitivo unico =====
...
(function(){
  const VERSION_ENTREGAS_190 = '3.3.9';
...
/* ===== v3.3.9 - Entregas: marcar hito final cuando el tránsito está cerrado =====
   Solo afecta la línea de tiempo de Entregas. */
(function(){
  const VERSION_ENTREGA_191='3.3.9';
...
/* ===== v3.3.9 - Entregas: cierre marca último hito =====
   Solo afecta la marcación visual de tarjetas cerradas en Entregas. */
(function(){
  const VERSION_ENTREGA_192='3.3.9';
...
/* ===== v3.3.9 - Entregas: cierre gana contra render heredado tardío =====
   Solo afecta la vista Entregas. Corrección finita, sin observer ni intervalos. */
(function(){
  const VERSION_ENTREGA_193='3.3.9';
...
(function(){
  ...
  async function finalRefresh195(btn){
    ...
    try{
      ...
      /* v3.3.9: renders tardíos heredados desactivados */
    }finally{
      setTimeout(()=>{
        if(b){ b.disabled=false; b.textContent=old || 'Actualizar'; }
        busy195=false;
...
/* ===== v3.3.9 - Entregas: fecha correcta de cierre y última actualización =====
   Solo afecta Entregas. Toma la fecha más nueva de registros del tránsito para cerrado. */
(function(){
  const VERSION_ENTREGA_196='3.3.9';
...
/* ===== v3.3.9 - Embarques only: sin render heredado =====
...
/* ===== v3.3.9 - Eliminar embarque real + hitos intermedios Entregas =====
   Corrige:
...
/* ===== v3.3.9 - Limpieza definitiva Entregas + Embarques =====
...
/* ===== v3.3.9 - Forzado final de version visible ===== */
(function(){
  const V='3.3.9';
  window.ELTA_APP_VERSION=V;
  window.APP_VERSION_V2=V;
...
/* ===== v3.3.9 - Confirmación eliminar + hitos Entregas por embarque =====
   Ajuste puntual:
...
/* ===== v3.3.9 - Ajustes Embarques + Entregas =====
...
/* ===== v3.3.9 - Corrección final línea de tiempo Entregas =====
...
/* ===== v3.3.9 - Bloqueo del último hito Entregas =====
   Mantiene la lógica de v3.3.9, pero evita que un render heredado posterior
...
/* ===== v3.3.9 - Entregas: bloqueo fuerte render heredado ultimo hito + modal rojo ===== */
(function(){
  const V='3.3.9';
  window.ELTA_APP_VERSION=V;
  window.APP_VERSION_V2=V;
...
/* ===== v3.3.9 - Bloqueo del render heredado que escribe INICIO =====
...
/* ===== v3.3.9 - Entregas: render final estable sin refresh heredado =====
...
/* ===== v3.3.9 - Entregas: bloqueo mínimo de INICIO sin tocar carga de datos =====
   Base: v3.3.9 estable. No modifica Firebase, refresh ni render principal.
...
/* ===== v3.3.9 - Entregas: fechas cierre + separación línea punteada =====
   Base v3.3.9. No toca Firebase ni render principal.
...
/* ===== v3.3.9 - Entregas: fechas inicio/cierre desde objetos Firebase + línea corta =====
   Base v3.3.9. No toca la carga de datos. Corrige sólo visualización final. */
(function(){
  const V='3.3.9';
  window.ELTA_APP_VERSION=V;
  window.APP_VERSION_V2=V;
...
/* ===== v3.3.9 - Entregas: fechas inicio/cierre robustas + línea vertical mínima =====
...
/* ===== ELTA v3.3.9 - VERSION Y DOCUMENTACION FINAL LIMPIA ===== */
(function(){
  'use strict';
  const VERSION='3.3.9';
...
/* ===== v3.3.9 - BITACORA OPERATIVA: MODULO UNICO SIN RENDER HEREDADO ===== */
(function(){
  'use strict';
  const VERSION='3.3.9';
